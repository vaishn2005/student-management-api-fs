...
/** Transcription mode. */
declare enum AudioTranscriptionConfigMode {
    /**
...
declare type Fetch = (input: RequestInfo | URL, init?: RequestInit) => Promise<Response>;
...
declare interface SpeechMetadata {
